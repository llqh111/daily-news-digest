...
def build_evidence_card(article: dict, session_logical_date: str = "") -> dict:
    ...
    card = {
        ...
        # Preserve source-level context required by downstream, read-only
        # consumers. These values are copied from the collected article; they
        # are not generated by the Hermes bot.
        "summary": article.get("summary", ""),
        "category": article.get("category") or article.get("topic") or "",
        "published_at": article.get("published") or "",
        "why_relevant": article.get("ai_reason") or "",
        "relevance_score": article.get("ai_score") or 0,
    }
